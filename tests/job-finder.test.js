...
describe('Job finder module', () => {
  ...
  test('Should query the right endpoint', async () => {
    ...
    await JobFinder.findJobs();

    expect(stub.args[0][0]).toEqual('https://jobs-api.x-team.com/jobs?populate[]=image&populate[]=isAlwaysHiring&populate[]=jobLocation&populate=skills&open=true&_sort=updated_at:DESC,priority:DESC');
  });
